...
Version  : 0.3.9
Release  : 12
URL      : https://download.gnome.org/sources/grilo/0.3/grilo-0.3.9.tar.xz
Source0  : https://download.gnome.org/sources/grilo/0.3/grilo-0.3.9.tar.xz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1568126805
...
cp COPYING %{buildroot}/usr/share/package-licenses/grilo/COPYING
...
/usr/lib64/libgrilo-0.3.so.0.309.1
/usr/lib64/libgrlnet-0.3.so.0
/usr/lib64/libgrlnet-0.3.so.0.309.0
/usr/lib64/libgrlpls-0.3.so.0
/usr/lib64/libgrlpls-0.3.so.0.309.0

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/grilo/COPYING
