...
Source0  : https://download.gnome.org/sources/grilo/0.3/grilo-0.3.5.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1531844262
...
/usr/lib64/libgrilo-0.3.so.0.1.4
/usr/lib64/libgrlnet-0.3.so.0
/usr/lib64/libgrlnet-0.3.so.0.0.4
