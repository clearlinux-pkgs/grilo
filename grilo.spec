...
Source0  : https://download.gnome.org/sources/grilo/0.3/grilo-0.3.12.tar.xz
...
%prep
%setup -q -n grilo-0.3.12
cd %{_builddir}/grilo-0.3.12
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585772736
...
cp %{_builddir}/grilo-0.3.12/COPYING %{buildroot}/usr/share/package-licenses/grilo/caeb68c46fa36651acf592771d09de7937926bb3
...
/usr/lib64/libgrilo-0.3.so.0.312.1
/usr/lib64/libgrlnet-0.3.so.0
/usr/lib64/libgrlnet-0.3.so.0.312.0
/usr/lib64/libgrlpls-0.3.so.0
/usr/lib64/libgrlpls-0.3.so.0.312.0
